!(function (t, e) {
  ...
  var jt =
    ...
    Zt = function (t) {
      return (
        k(qt, t) ||
          (jt && k(Dt, t) ? (qt[t] = Dt[t]) : (qt[t] = Ut("Symbol." + t))),
        qt[t]
      );
    },
    Wt = Zt("species"),
    ...
    return [
      ...
      function (t) {
        ...
        for (var l, s = [], c = 0; null !== (l = Qt(i, a)); ) {
          var u = String(l[0]);
          (s[c] = u),
            "" === u && (i.lastIndex = Xt(a, ot(i.lastIndex), o)),
            c++;
        }
        return 0 === c ? null : s;
      },
  ...
  Yt("search", 1, function (t, e, n) {
    return [
      ...
      function (t) {
        ...
        var l = Qt(i, a);
        return (
          te(i.lastIndex, o) || (i.lastIndex = o), null === l ? -1 : l.index
        );
      },
    ];
  });
    ...
    Oe = function (t, e) {
      ...
      return (ze[t] =
        ...
        !i(function () {
          if (r && !a) return !0;
          var t = { length: -1 };
          r ? Ae(t, 1, { enumerable: !0, get: Re }) : (t[1] = 1),
            n.call(t, o, l);
        }));
    },
    Ie = pt.indexOf,
        ...
        [
          ...
          function (t, i) {
            ...
            for (var f = 0, h = 0, g = []; h < l.length; ) {
              ...
              if (
                null === v ||
                (m = qn(ot(p.lastIndex + (Dn ? 0 : h)), l.length)) === f
              )
                h = Xt(l, h, c);
              else {
  ...
  var Qn = Vn.end,
    ...
    er = tr
      ...
      : "".trimEnd;
  _t(
    { target: "String", proto: !0, forced: tr },
    { trimEnd: er, trimRight: er }
  );
  var nr = e(function (t) {
      function e() {
        return {
  ...
  _t(
    { target: "Array", proto: !0, forced: !rr || !ir },
    {
      splice: function (t, e) {
        ...
        for (i = Ke(s, r), a = 0; a < r; a++)
          (o = u + a) in s && an(i, a, s[o]);
        if (((i.length = r), n < r)) {
          for (a = u; a < c - r; a++)
              ...
              if (i)
                return (
                  (r =
                    "@" === i[2]
                      ? "mailto:" +
                        (n = jr(this.options.mangle ? e(i[1]) : i[1]))
                      : (n = jr(i[1]))),
                  {
                    type: "link",
                    raw: i[0],
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if ((n = this.rules.inline.url.exec(t))) {
                ...
                if ("@" === n[2])
                  i =
                    "mailto:" + (r = jr(this.options.mangle ? e(n[0]) : n[0]));
                else {
                  var a;
                  do {
                    (a = n[0]),
        ...
        fe(t, [
          ...
          },
          {
            ...
            value: function (t, e, n) {
              if (
                null ===
                (t = ti(this.options.sanitize, this.options.baseUrl, t))
              )
                return n;
              var r = '<a href="' + ei(t) + '"';
